        ...
        <div className={styles.footerContent}>
            ...
            <div className={styles.footer__contact}>
                ...
                <div className={styles.footerContactsWrapper}>
                    <a className={styles.footerLinkfooterLinkBold} href="tel:88000000000">
                    ...
                    <a className={styles.footerLinkfooterLinkMail} href="mailto:email@email.com">
                    ...
                    <a className={styles.footerLinkfooterLinkPoint} href="#">
